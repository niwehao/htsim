...
public:
    ...
    void receivePacket(Packet& pkt) override {
        ...
        // v12: 源侧资源完全追踪, 下游 (spine egress / dstLeaf) 允许排队.
        // fabric 20x faster 保证快速消化. 阈值 16 包 (与 Dragonfly 一致).
        static constexpr int64_t BUF_WARN_THRESHOLD = (int64_t)DATA_PKT_SIZE * PORTS_PER_SWITCH ;
